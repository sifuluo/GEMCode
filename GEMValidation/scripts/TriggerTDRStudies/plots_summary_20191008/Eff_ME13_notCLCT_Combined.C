...
tex->SetNDC();
   ...
   den_clone95->SetPassedEvents(1,86);
   den_clone95->SetTotalEvents(2,407);
   den_clone95->SetPassedEvents(2,31);
   den_clone95->SetTotalEvents(3,389);
   den_clone95->SetPassedEvents(3,8);
   den_clone95->SetTotalEvents(4,457);
   den_clone95->SetPassedEvents(4,12);
   den_clone95->SetTotalEvents(5,403);
   den_clone95->SetPassedEvents(5,4);
   den_clone95->SetTotalEvents(6,415);
   den_clone95->SetPassedEvents(6,13);
   den_clone95->SetTotalEvents(7,410);
   den_clone95->SetPassedEvents(7,11);
   den_clone95->SetTotalEvents(8,460);
   den_clone95->SetPassedEvents(8,18);
   den_clone95->SetTotalEvents(9,371);
   den_clone95->SetPassedEvents(9,8);
   den_clone95->SetTotalEvents(10,403);
   den_clone95->SetPassedEvents(10,11);
   den_clone95->SetTotalEvents(11,424);
   den_clone95->SetPassedEvents(11,5);
   den_clone95->SetTotalEvents(12,371);
   den_clone95->SetPassedEvents(12,7);
   den_clone95->SetTotalEvents(13,397);
   den_clone95->SetPassedEvents(13,7);
   den_clone95->SetTotalEvents(14,428);
   den_clone95->SetPassedEvents(14,7);
   den_clone95->SetTotalEvents(15,380);
   den_clone95->SetPassedEvents(15,10);
   den_clone95->SetTotalEvents(16,396);
   den_clone95->SetPassedEvents(16,17);
   den_clone95->SetTotalEvents(17,362);
   den_clone95->SetPassedEvents(17,16);
