...
tex->SetNDC();
   ...
   den_clone76->SetPassedEvents(2,1070);
   den_clone76->SetTotalEvents(3,1397);
   den_clone76->SetPassedEvents(3,1351);
   den_clone76->SetTotalEvents(4,1411);
   den_clone76->SetPassedEvents(4,1371);
   den_clone76->SetTotalEvents(5,1475);
   den_clone76->SetPassedEvents(5,1346);
   den_clone76->SetTotalEvents(6,1407);
   den_clone76->SetPassedEvents(6,1269);
   den_clone76->SetTotalEvents(7,1358);
   den_clone76->SetPassedEvents(7,1215);
   den_clone76->SetTotalEvents(8,1366);
   den_clone76->SetPassedEvents(8,1290);
   den_clone76->SetTotalEvents(9,1305);
   den_clone76->SetPassedEvents(9,1271);
   den_clone76->SetTotalEvents(10,1465);
   den_clone76->SetPassedEvents(10,1419);
   den_clone76->SetTotalEvents(11,1413);
   den_clone76->SetPassedEvents(11,1369);
   den_clone76->SetTotalEvents(12,1344);
   den_clone76->SetPassedEvents(12,1270);
   den_clone76->SetTotalEvents(13,1435);
   den_clone76->SetPassedEvents(13,1156);
   den_clone76->SetTotalEvents(14,1403);
   den_clone76->SetPassedEvents(14,1170);
   den_clone76->SetTotalEvents(15,1342);
   den_clone76->SetPassedEvents(15,1057);
   den_clone76->SetTotalEvents(16,1332);
   den_clone76->SetPassedEvents(16,1225);
   den_clone76->SetTotalEvents(17,1446);
   den_clone76->SetPassedEvents(17,1377);
   den_clone76->SetTotalEvents(18,1424);
   den_clone76->SetPassedEvents(18,1355);
   den_clone76->SetTotalEvents(19,1381);
   den_clone76->SetPassedEvents(19,1320);
   den_clone76->SetTotalEvents(20,1389);
   den_clone76->SetPassedEvents(20,1300);
   den_clone76->SetTotalEvents(21,1197);
   den_clone76->SetPassedEvents(21,1054);
   den_clone76->SetTotalEvents(22,900);
   den_clone76->SetPassedEvents(22,732);
   den_clone76->SetTotalEvents(23,639);
   den_clone76->SetPassedEvents(23,460);
   ...
   den_clone77->SetPassedEvents(1,691);
   den_clone77->SetTotalEvents(2,1220);
   den_clone77->SetPassedEvents(2,1070);
   den_clone77->SetTotalEvents(3,1397);
   den_clone77->SetPassedEvents(3,1351);
   den_clone77->SetTotalEvents(4,1411);
   den_clone77->SetPassedEvents(4,1371);
   den_clone77->SetTotalEvents(5,1475);
   den_clone77->SetPassedEvents(5,1346);
   den_clone77->SetTotalEvents(6,1407);
   den_clone77->SetPassedEvents(6,1269);
   den_clone77->SetTotalEvents(7,1358);
   den_clone77->SetPassedEvents(7,1215);
   den_clone77->SetTotalEvents(8,1366);
   den_clone77->SetPassedEvents(8,1290);
   den_clone77->SetTotalEvents(9,1305);
   den_clone77->SetPassedEvents(9,1271);
   den_clone77->SetTotalEvents(10,1465);
   den_clone77->SetPassedEvents(10,1419);
   den_clone77->SetTotalEvents(11,1413);
   den_clone77->SetPassedEvents(11,1369);
   den_clone77->SetTotalEvents(12,1344);
   den_clone77->SetPassedEvents(12,1270);
   den_clone77->SetTotalEvents(13,1435);
   den_clone77->SetPassedEvents(13,1156);
   den_clone77->SetTotalEvents(14,1403);
   den_clone77->SetPassedEvents(14,1170);
   den_clone77->SetTotalEvents(15,1342);
   den_clone77->SetPassedEvents(15,1057);
   den_clone77->SetTotalEvents(16,1332);
   den_clone77->SetPassedEvents(16,1225);
   den_clone77->SetTotalEvents(17,1446);
   den_clone77->SetPassedEvents(17,1377);
   den_clone77->SetTotalEvents(18,1424);
   den_clone77->SetPassedEvents(18,1355);
   den_clone77->SetTotalEvents(19,1381);
   den_clone77->SetPassedEvents(19,1320);
   den_clone77->SetTotalEvents(20,1389);
   den_clone77->SetPassedEvents(20,1300);
   den_clone77->SetTotalEvents(21,1197);
   den_clone77->SetPassedEvents(21,1054);
   den_clone77->SetTotalEvents(22,900);
   den_clone77->SetPassedEvents(22,732);
   den_clone77->SetTotalEvents(23,639);
   den_clone77->SetPassedEvents(23,460);
   den_clone77->SetTotalEvents(24,66);
   den_clone77->SetPassedEvents(24,20);
