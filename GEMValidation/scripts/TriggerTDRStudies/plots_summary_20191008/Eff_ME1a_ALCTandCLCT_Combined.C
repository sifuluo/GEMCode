...
//=========  (Wed Oct  9 13:37:46 2019) by ROOT version 6.14/09
...
tex->SetNDC();
   ...
   den_clone30->SetPassedEvents(1,421);
   den_clone30->SetTotalEvents(2,714);
   den_clone30->SetPassedEvents(2,496);
   den_clone30->SetTotalEvents(3,880);
   den_clone30->SetPassedEvents(3,803);
   den_clone30->SetTotalEvents(4,843);
   den_clone30->SetPassedEvents(4,812);
   den_clone30->SetTotalEvents(5,858);
   den_clone30->SetPassedEvents(5,842);
   den_clone30->SetTotalEvents(6,854);
   den_clone30->SetPassedEvents(6,826);
   den_clone30->SetTotalEvents(7,837);
   den_clone30->SetPassedEvents(7,799);
   den_clone30->SetTotalEvents(8,861);
   den_clone30->SetPassedEvents(8,832);
   den_clone30->SetTotalEvents(9,766);
   den_clone30->SetPassedEvents(9,742);
   den_clone30->SetTotalEvents(10,879);
   den_clone30->SetPassedEvents(10,850);
   den_clone30->SetTotalEvents(11,845);
   den_clone30->SetPassedEvents(11,809);
   den_clone30->SetTotalEvents(12,864);
   den_clone30->SetPassedEvents(12,834);
   den_clone30->SetTotalEvents(13,869);
   den_clone30->SetPassedEvents(13,835);
   den_clone30->SetTotalEvents(14,852);
   den_clone30->SetPassedEvents(14,832);
   den_clone30->SetTotalEvents(15,823);
   den_clone30->SetPassedEvents(15,790);
   den_clone30->SetTotalEvents(16,777);
   den_clone30->SetPassedEvents(16,752);
   den_clone30->SetTotalEvents(17,827);
   den_clone30->SetPassedEvents(17,796);
   den_clone30->SetTotalEvents(18,860);
   den_clone30->SetPassedEvents(18,825);
   den_clone30->SetTotalEvents(19,884);
   den_clone30->SetPassedEvents(19,845);
   den_clone30->SetTotalEvents(20,844);
   den_clone30->SetPassedEvents(20,808);
   den_clone30->SetTotalEvents(21,845);
   den_clone30->SetPassedEvents(21,819);
   den_clone30->SetTotalEvents(22,771);
   den_clone30->SetPassedEvents(22,734);
   den_clone30->SetTotalEvents(23,885);
   den_clone30->SetPassedEvents(23,835);
   den_clone30->SetTotalEvents(24,859);
   den_clone30->SetPassedEvents(24,807);
   den_clone30->SetTotalEvents(25,744);
   den_clone30->SetPassedEvents(25,631);
   ...
   den_clone31->SetPassedEvents(1,384);
   den_clone31->SetTotalEvents(2,781);
   den_clone31->SetPassedEvents(2,483);
   den_clone31->SetTotalEvents(3,835);
   den_clone31->SetPassedEvents(3,643);
   den_clone31->SetTotalEvents(4,749);
   den_clone31->SetPassedEvents(4,628);
   den_clone31->SetTotalEvents(5,811);
   den_clone31->SetPassedEvents(5,676);
   den_clone31->SetTotalEvents(6,841);
   den_clone31->SetPassedEvents(6,710);
   den_clone31->SetTotalEvents(7,848);
   den_clone31->SetPassedEvents(7,707);
   den_clone31->SetTotalEvents(8,876);
   den_clone31->SetPassedEvents(8,727);
   den_clone31->SetTotalEvents(9,842);
   den_clone31->SetPassedEvents(9,712);
   den_clone31->SetTotalEvents(10,790);
   den_clone31->SetPassedEvents(10,643);
   den_clone31->SetTotalEvents(11,811);
   den_clone31->SetPassedEvents(11,680);
   den_clone31->SetTotalEvents(12,830);
   den_clone31->SetPassedEvents(12,695);
   den_clone31->SetTotalEvents(13,795);
   den_clone31->SetPassedEvents(13,666);
   den_clone31->SetTotalEvents(14,811);
   den_clone31->SetPassedEvents(14,666);
   den_clone31->SetTotalEvents(15,862);
   den_clone31->SetPassedEvents(15,718);
   den_clone31->SetTotalEvents(16,848);
   den_clone31->SetPassedEvents(16,719);
   den_clone31->SetTotalEvents(17,824);
   den_clone31->SetPassedEvents(17,663);
   den_clone31->SetTotalEvents(18,816);
   den_clone31->SetPassedEvents(18,656);
   den_clone31->SetTotalEvents(19,859);
   den_clone31->SetPassedEvents(19,692);
   den_clone31->SetTotalEvents(20,800);
   den_clone31->SetPassedEvents(20,650);
   den_clone31->SetTotalEvents(21,807);
   den_clone31->SetPassedEvents(21,667);
   den_clone31->SetTotalEvents(22,772);
   den_clone31->SetPassedEvents(22,610);
   den_clone31->SetTotalEvents(23,833);
   den_clone31->SetPassedEvents(23,693);
   den_clone31->SetTotalEvents(24,756);
   den_clone31->SetPassedEvents(24,603);
   den_clone31->SetTotalEvents(25,840);
   den_clone31->SetPassedEvents(25,610);
   ...
   den_clone32->SetPassedEvents(1,419);
   den_clone32->SetTotalEvents(2,781);
   den_clone32->SetPassedEvents(2,544);
   den_clone32->SetTotalEvents(3,835);
   den_clone32->SetPassedEvents(3,730);
   den_clone32->SetTotalEvents(4,749);
   den_clone32->SetPassedEvents(4,715);
   den_clone32->SetTotalEvents(5,811);
   den_clone32->SetPassedEvents(5,780);
   den_clone32->SetTotalEvents(6,841);
   den_clone32->SetPassedEvents(6,790);
   den_clone32->SetTotalEvents(7,848);
   den_clone32->SetPassedEvents(7,814);
   den_clone32->SetTotalEvents(8,876);
   den_clone32->SetPassedEvents(8,844);
   den_clone32->SetTotalEvents(9,842);
   den_clone32->SetPassedEvents(9,813);
   den_clone32->SetTotalEvents(10,790);
   den_clone32->SetPassedEvents(10,752);
   den_clone32->SetTotalEvents(11,811);
   den_clone32->SetPassedEvents(11,764);
   den_clone32->SetTotalEvents(12,830);
   den_clone32->SetPassedEvents(12,789);
   den_clone32->SetTotalEvents(13,795);
   den_clone32->SetPassedEvents(13,760);
   den_clone32->SetTotalEvents(14,811);
   den_clone32->SetPassedEvents(14,765);
   den_clone32->SetTotalEvents(15,862);
   den_clone32->SetPassedEvents(15,812);
   den_clone32->SetTotalEvents(16,848);
   den_clone32->SetPassedEvents(16,802);
   den_clone32->SetTotalEvents(17,824);
   den_clone32->SetPassedEvents(17,770);
   den_clone32->SetTotalEvents(18,816);
   den_clone32->SetPassedEvents(18,766);
   den_clone32->SetTotalEvents(19,859);
   den_clone32->SetPassedEvents(19,805);
   den_clone32->SetTotalEvents(20,800);
   den_clone32->SetPassedEvents(20,755);
   den_clone32->SetTotalEvents(21,807);
   den_clone32->SetPassedEvents(21,755);
   den_clone32->SetTotalEvents(22,772);
   den_clone32->SetPassedEvents(22,721);
   den_clone32->SetTotalEvents(23,833);
   den_clone32->SetPassedEvents(23,781);
   den_clone32->SetTotalEvents(24,756);
   den_clone32->SetPassedEvents(24,696);
   den_clone32->SetTotalEvents(25,840);
   den_clone32->SetPassedEvents(25,694);
