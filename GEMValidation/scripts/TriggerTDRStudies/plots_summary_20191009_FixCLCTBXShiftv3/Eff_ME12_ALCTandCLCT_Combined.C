...
tex->SetNDC();
   ...
   den_clone201->SetPassedEvents(1,706);
   den_clone201->SetTotalEvents(2,1213);
   den_clone201->SetPassedEvents(2,1009);
   den_clone201->SetTotalEvents(3,1354);
   den_clone201->SetPassedEvents(3,1280);
   den_clone201->SetTotalEvents(4,1323);
   den_clone201->SetPassedEvents(4,1230);
   den_clone201->SetTotalEvents(5,1390);
   den_clone201->SetPassedEvents(5,1164);
   den_clone201->SetTotalEvents(6,1462);
   den_clone201->SetPassedEvents(6,1258);
   den_clone201->SetTotalEvents(7,1398);
   den_clone201->SetPassedEvents(7,1125);
   den_clone201->SetTotalEvents(8,1433);
   den_clone201->SetPassedEvents(8,1265);
   den_clone201->SetTotalEvents(9,1329);
   den_clone201->SetPassedEvents(9,1230);
   den_clone201->SetTotalEvents(10,1404);
   den_clone201->SetPassedEvents(10,1284);
   den_clone201->SetTotalEvents(11,1430);
   den_clone201->SetPassedEvents(11,1302);
   den_clone201->SetTotalEvents(12,1367);
   den_clone201->SetPassedEvents(12,1246);
   den_clone201->SetTotalEvents(13,1349);
   den_clone201->SetPassedEvents(13,989);
   den_clone201->SetTotalEvents(14,1357);
   den_clone201->SetPassedEvents(14,1055);
   den_clone201->SetTotalEvents(15,1298);
   den_clone201->SetPassedEvents(15,910);
   den_clone201->SetTotalEvents(16,1436);
   den_clone201->SetPassedEvents(16,1192);
   den_clone201->SetTotalEvents(17,1307);
   den_clone201->SetPassedEvents(17,1141);
   den_clone201->SetTotalEvents(18,1268);
   den_clone201->SetPassedEvents(18,1110);
   den_clone201->SetTotalEvents(19,1329);
   den_clone201->SetPassedEvents(19,1138);
   den_clone201->SetTotalEvents(20,1413);
   den_clone201->SetPassedEvents(20,1189);
   den_clone201->SetTotalEvents(21,1263);
   den_clone201->SetPassedEvents(21,963);
   den_clone201->SetTotalEvents(22,804);
   den_clone201->SetPassedEvents(22,597);
   den_clone201->SetTotalEvents(23,621);
   den_clone201->SetPassedEvents(23,377);
   den_clone201->SetTotalEvents(24,81);
   den_clone201->SetPassedEvents(24,18);
   ...
   den_clone202->SetPassedEvents(1,667);
   den_clone202->SetTotalEvents(2,1220);
   den_clone202->SetPassedEvents(2,1020);
   den_clone202->SetTotalEvents(3,1397);
   den_clone202->SetPassedEvents(3,1299);
   den_clone202->SetTotalEvents(4,1411);
   den_clone202->SetPassedEvents(4,1306);
   den_clone202->SetTotalEvents(5,1475);
   den_clone202->SetPassedEvents(5,1238);
   den_clone202->SetTotalEvents(6,1407);
   den_clone202->SetPassedEvents(6,1176);
   den_clone202->SetTotalEvents(7,1358);
   den_clone202->SetPassedEvents(7,1119);
   den_clone202->SetTotalEvents(8,1366);
   den_clone202->SetPassedEvents(8,1214);
   den_clone202->SetTotalEvents(9,1305);
   den_clone202->SetPassedEvents(9,1205);
   den_clone202->SetTotalEvents(10,1465);
   den_clone202->SetPassedEvents(10,1328);
   den_clone202->SetTotalEvents(11,1413);
   den_clone202->SetPassedEvents(11,1286);
   den_clone202->SetTotalEvents(12,1344);
   den_clone202->SetPassedEvents(12,1193);
   den_clone202->SetTotalEvents(13,1435);
   den_clone202->SetPassedEvents(13,1053);
   den_clone202->SetTotalEvents(14,1403);
   den_clone202->SetPassedEvents(14,1068);
   den_clone202->SetTotalEvents(15,1342);
   den_clone202->SetPassedEvents(15,929);
   den_clone202->SetTotalEvents(16,1332);
   den_clone202->SetPassedEvents(16,1114);
   den_clone202->SetTotalEvents(17,1446);
   den_clone202->SetPassedEvents(17,1259);
   den_clone202->SetTotalEvents(18,1424);
   den_clone202->SetPassedEvents(18,1216);
   den_clone202->SetTotalEvents(19,1381);
   den_clone202->SetPassedEvents(19,1180);
   den_clone202->SetTotalEvents(20,1389);
   den_clone202->SetPassedEvents(20,1135);
   den_clone202->SetTotalEvents(21,1197);
   den_clone202->SetPassedEvents(21,913);
   den_clone202->SetTotalEvents(22,900);
   den_clone202->SetPassedEvents(22,638);
   den_clone202->SetTotalEvents(23,639);
   den_clone202->SetPassedEvents(23,402);
   den_clone202->SetTotalEvents(24,66);
   den_clone202->SetPassedEvents(24,18);
   ...
   den_clone203->SetPassedEvents(1,667);
   den_clone203->SetTotalEvents(2,1220);
   den_clone203->SetPassedEvents(2,1020);
   den_clone203->SetTotalEvents(3,1397);
   den_clone203->SetPassedEvents(3,1299);
   den_clone203->SetTotalEvents(4,1411);
   den_clone203->SetPassedEvents(4,1306);
   den_clone203->SetTotalEvents(5,1475);
   den_clone203->SetPassedEvents(5,1238);
   den_clone203->SetTotalEvents(6,1407);
   den_clone203->SetPassedEvents(6,1176);
   den_clone203->SetTotalEvents(7,1358);
   den_clone203->SetPassedEvents(7,1119);
   den_clone203->SetTotalEvents(8,1366);
   den_clone203->SetPassedEvents(8,1214);
   den_clone203->SetTotalEvents(9,1305);
   den_clone203->SetPassedEvents(9,1205);
   den_clone203->SetTotalEvents(10,1465);
   den_clone203->SetPassedEvents(10,1328);
   den_clone203->SetTotalEvents(11,1413);
   den_clone203->SetPassedEvents(11,1286);
   den_clone203->SetTotalEvents(12,1344);
   den_clone203->SetPassedEvents(12,1193);
   den_clone203->SetTotalEvents(13,1435);
   den_clone203->SetPassedEvents(13,1053);
   den_clone203->SetTotalEvents(14,1403);
   den_clone203->SetPassedEvents(14,1068);
   den_clone203->SetTotalEvents(15,1342);
   den_clone203->SetPassedEvents(15,929);
   den_clone203->SetTotalEvents(16,1332);
   den_clone203->SetPassedEvents(16,1114);
   den_clone203->SetTotalEvents(17,1446);
   den_clone203->SetPassedEvents(17,1259);
   den_clone203->SetTotalEvents(18,1424);
   den_clone203->SetPassedEvents(18,1216);
   den_clone203->SetTotalEvents(19,1381);
   den_clone203->SetPassedEvents(19,1180);
   den_clone203->SetTotalEvents(20,1389);
   den_clone203->SetPassedEvents(20,1135);
   den_clone203->SetTotalEvents(21,1197);
   den_clone203->SetPassedEvents(21,913);
   den_clone203->SetTotalEvents(22,900);
   den_clone203->SetPassedEvents(22,638);
   den_clone203->SetTotalEvents(23,639);
   den_clone203->SetPassedEvents(23,402);
   den_clone203->SetTotalEvents(24,66);
   den_clone203->SetPassedEvents(24,18);
