...
tex->SetNDC();
   ...
   den_clone565->SetPassedEvents(1,10);
   den_clone565->SetTotalEvents(2,49);
   den_clone565->SetPassedEvents(2,32);
   den_clone565->SetTotalEvents(3,365);
   den_clone565->SetPassedEvents(3,220);
   den_clone565->SetTotalEvents(4,1528);
   den_clone565->SetPassedEvents(4,1291);
   den_clone565->SetTotalEvents(5,1998);
   den_clone565->SetPassedEvents(5,1779);
   den_clone565->SetTotalEvents(6,1867);
   den_clone565->SetPassedEvents(6,1590);
   den_clone565->SetTotalEvents(7,1882);
   den_clone565->SetPassedEvents(7,1597);
   den_clone565->SetTotalEvents(8,2038);
   den_clone565->SetPassedEvents(8,1821);
   den_clone565->SetTotalEvents(9,1957);
   den_clone565->SetPassedEvents(9,1645);
   den_clone565->SetTotalEvents(10,1907);
   den_clone565->SetPassedEvents(10,1585);
   den_clone565->SetTotalEvents(11,1928);
   den_clone565->SetPassedEvents(11,1718);
   den_clone565->SetTotalEvents(12,1994);
   den_clone565->SetPassedEvents(12,1737);
   den_clone565->SetTotalEvents(13,1910);
   den_clone565->SetPassedEvents(13,1508);
   den_clone565->SetTotalEvents(14,1837);
   den_clone565->SetPassedEvents(14,1547);
   den_clone565->SetTotalEvents(15,1967);
   den_clone565->SetPassedEvents(15,1752);
   den_clone565->SetTotalEvents(16,1864);
   den_clone565->SetPassedEvents(16,1645);
   den_clone565->SetTotalEvents(17,1753);
   den_clone565->SetPassedEvents(17,1316);
   den_clone565->SetTotalEvents(18,1982);
   den_clone565->SetPassedEvents(18,1559);
   den_clone565->SetTotalEvents(19,1802);
   den_clone565->SetPassedEvents(19,1573);
   den_clone565->SetTotalEvents(20,1925);
   den_clone565->SetPassedEvents(20,1677);
   den_clone565->SetTotalEvents(21,1900);
   den_clone565->SetPassedEvents(21,1611);
   den_clone565->SetTotalEvents(22,1946);
   den_clone565->SetPassedEvents(22,1644);
   den_clone565->SetTotalEvents(23,1858);
   den_clone565->SetPassedEvents(23,1555);
   den_clone565->SetTotalEvents(24,939);
   den_clone565->SetPassedEvents(24,617);
   den_clone565->SetTotalEvents(25,32);
   den_clone565->SetPassedEvents(25,11);
   ...
   den_clone566->SetPassedEvents(1,7);
   den_clone566->SetTotalEvents(2,33);
   den_clone566->SetPassedEvents(2,19);
   den_clone566->SetTotalEvents(3,378);
   den_clone566->SetPassedEvents(3,231);
   den_clone566->SetTotalEvents(4,1482);
   den_clone566->SetPassedEvents(4,1231);
   den_clone566->SetTotalEvents(5,1960);
   den_clone566->SetPassedEvents(5,1750);
   den_clone566->SetTotalEvents(6,1946);
   den_clone566->SetPassedEvents(6,1629);
   den_clone566->SetTotalEvents(7,2014);
   den_clone566->SetPassedEvents(7,1723);
   den_clone566->SetTotalEvents(8,1984);
   den_clone566->SetPassedEvents(8,1800);
   den_clone566->SetTotalEvents(9,1927);
   den_clone566->SetPassedEvents(9,1619);
   den_clone566->SetTotalEvents(10,1815);
   den_clone566->SetPassedEvents(10,1521);
   den_clone566->SetTotalEvents(11,2052);
   den_clone566->SetPassedEvents(11,1842);
   den_clone566->SetTotalEvents(12,1874);
   den_clone566->SetPassedEvents(12,1648);
   den_clone566->SetTotalEvents(13,1997);
   den_clone566->SetPassedEvents(13,1603);
   den_clone566->SetTotalEvents(14,1964);
   den_clone566->SetPassedEvents(14,1656);
   den_clone566->SetTotalEvents(15,1853);
   den_clone566->SetPassedEvents(15,1642);
   den_clone566->SetTotalEvents(16,2061);
   den_clone566->SetPassedEvents(16,1819);
   den_clone566->SetTotalEvents(17,1946);
   den_clone566->SetPassedEvents(17,1467);
   den_clone566->SetTotalEvents(18,1899);
   den_clone566->SetPassedEvents(18,1483);
   den_clone566->SetTotalEvents(19,1921);
   den_clone566->SetPassedEvents(19,1685);
   den_clone566->SetTotalEvents(20,1951);
   den_clone566->SetPassedEvents(20,1706);
   den_clone566->SetTotalEvents(21,1903);
   den_clone566->SetPassedEvents(21,1655);
   den_clone566->SetTotalEvents(22,1814);
   den_clone566->SetPassedEvents(22,1532);
   den_clone566->SetTotalEvents(23,1798);
   den_clone566->SetPassedEvents(23,1471);
   den_clone566->SetTotalEvents(24,977);
   den_clone566->SetPassedEvents(24,650);
   den_clone566->SetTotalEvents(25,35);
   den_clone566->SetPassedEvents(25,11);
   ...
   den_clone567->SetPassedEvents(1,7);
   den_clone567->SetTotalEvents(2,33);
   den_clone567->SetPassedEvents(2,19);
   den_clone567->SetTotalEvents(3,378);
   den_clone567->SetPassedEvents(3,231);
   den_clone567->SetTotalEvents(4,1482);
   den_clone567->SetPassedEvents(4,1231);
   den_clone567->SetTotalEvents(5,1960);
   den_clone567->SetPassedEvents(5,1750);
   den_clone567->SetTotalEvents(6,1946);
   den_clone567->SetPassedEvents(6,1629);
   den_clone567->SetTotalEvents(7,2014);
   den_clone567->SetPassedEvents(7,1723);
   den_clone567->SetTotalEvents(8,1984);
   den_clone567->SetPassedEvents(8,1800);
   den_clone567->SetTotalEvents(9,1927);
   den_clone567->SetPassedEvents(9,1619);
   den_clone567->SetTotalEvents(10,1815);
   den_clone567->SetPassedEvents(10,1521);
   den_clone567->SetTotalEvents(11,2052);
   den_clone567->SetPassedEvents(11,1842);
   den_clone567->SetTotalEvents(12,1874);
   den_clone567->SetPassedEvents(12,1648);
   den_clone567->SetTotalEvents(13,1997);
   den_clone567->SetPassedEvents(13,1603);
   den_clone567->SetTotalEvents(14,1964);
   den_clone567->SetPassedEvents(14,1656);
   den_clone567->SetTotalEvents(15,1853);
   den_clone567->SetPassedEvents(15,1642);
   den_clone567->SetTotalEvents(16,2061);
   den_clone567->SetPassedEvents(16,1819);
   den_clone567->SetTotalEvents(17,1946);
   den_clone567->SetPassedEvents(17,1467);
   den_clone567->SetTotalEvents(18,1899);
   den_clone567->SetPassedEvents(18,1483);
   den_clone567->SetTotalEvents(19,1921);
   den_clone567->SetPassedEvents(19,1685);
   den_clone567->SetTotalEvents(20,1951);
   den_clone567->SetPassedEvents(20,1706);
   den_clone567->SetTotalEvents(21,1903);
   den_clone567->SetPassedEvents(21,1655);
   den_clone567->SetTotalEvents(22,1814);
   den_clone567->SetPassedEvents(22,1532);
   den_clone567->SetTotalEvents(23,1798);
   den_clone567->SetPassedEvents(23,1471);
   den_clone567->SetTotalEvents(24,977);
   den_clone567->SetPassedEvents(24,650);
   den_clone567->SetTotalEvents(25,35);
   den_clone567->SetPassedEvents(25,11);
