...
//=========  (Mon Oct  7 19:53:40 2019) by ROOT version 6.14/09
   ...
   c->Range(-1.428571,-31.9725,10.47619,234.465);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   num__12->SetBinContent(1,203);
   num__12->SetBinContent(2,8);
   num__12->SetBinContent(3,1);
   ...
   num__12->GetXaxis()->SetTitle("TimingError");
