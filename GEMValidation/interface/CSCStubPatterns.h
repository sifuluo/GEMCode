...
namespace {
  ...
  std::vector<std::vector<int> > pat0delta{{999, 999, 999, 999, 999, 999, 999, 999, 999, 999, 999},
                                           {999, 999, 999, 999, 999},
  ...
  std::vector<std::vector<int> > pat2delta{{999, 999, 999, 999, 999, 999, 999, 999, 3, 4, 5},
                                           {999, 999, 999, 1, 2},
  ...
  std::vector<std::vector<int> > pat3delta{{-5, -4, -3, 999, 999, 999, 999, 999, 999, 999, 999},
                                           {-2, -1, 999, 999, 999},
  ...
  std::vector<std::vector<int> > pat4delta{{999, 999, 999, 999, 999, 999, 999, 2, 3, 4, 999},
                                           {999, 999, 999, 1, 2},
  ...
  std::vector<std::vector<int> > pat5delta{{999, -4, -3, -2, 999, 999, 999, 999, 999, 999, 999},
                                           {-2, -1, 999, 999, 999},
  ...
  std::vector<std::vector<int> > pat6delta{{999, 999, 999, 999, 999, 999, 1, 2, 3, 999, 999},
                                           {999, 999, 0, 1, 999},
  ...
  std::vector<std::vector<int> > pat7delta{{999, 999, -3, -2, -1, 999, 999, 999, 999, 999, 999},
                                           {999, -1, 0, 999, 999},
  ...
  std::vector<std::vector<int> > pat8delta{{999, 999, 999, 999, 999, 0, 1, 2, 999, 999, 999},
                                           {999, 999, 0, 1, 999},
  ...
  std::vector<std::vector<int> > pat9delta{{999, 999, 999, -2, -1, 0, 999, 999, 999, 999, 999},
                                           {999, -1, 0, 999, 999},
  ...
  std::vector<std::vector<int> > patAdelta{{999, 999, 999, 999, -1, 0, 1, 999, 999, 999, 999},
                                           {999, 999, 0, 999, 999},
  ...
  std::vector<std::vector<std::vector<int> > > patIndexToPatternDelta{pat0delta,
                                                                      pat1delta,
                                                                      pat2delta,
                                                                      pat3delta,
                                                                      pat4delta,
  ...
  bool comparatorInLCTPattern(int keyStrip, int pattern, int layer, int halfStrip) {
    ...
    if (debug)
      for (auto p : subpat)
        std::cout << "\t" << p << std::endl;
    if (debug)
      std::cout << "\tkeyStrip pattern layer halfstrip " << keyStrip << " " << pattern << " " << layer << " "
                << halfStrip << std::endl
                << std::endl;
